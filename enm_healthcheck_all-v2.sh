...
#
#  Deploy  : /home/eric/scripts/ajiteguh/enm_healthcheck_all-v2.sh
#  Output  : /home/eric/scripts/ajiteguh/output_healthcheck/
#  Summary : /home/eric/scripts/ajiteguh/output_healthcheck/summary/
#
#  Usage   :
#    ./enm_healthcheck_all-v2.sh              # Interactive menu (pick servers)
#    ./enm_healthcheck_all-v2.sh --all        # All servers (for cronjob)
#    ./enm_healthcheck_all-v2.sh ENMR1        # Single server
#    ./enm_healthcheck_all-v2.sh ENMR1 ENMR4  # Multiple servers
#    ./enm_healthcheck_all-v2.sh --list       # Show available servers
#
#  Cron    :
#    0 5 * * * /home/eric/scripts/ajiteguh/enm_healthcheck_all-v2.sh --all
#
#  Changes from v3.0:
#    - Fixed: ENMJ1 banner with ### chars was falsely matching as shell prompt
#      Now uses sleep-based approach after password — no prompt detection at all
#    - Fixed: If one server errors/hangs, script continues to next server
#      Each server is wrapped in a 2-hour bash timeout
#    - Fixed: Sentinel marker cleaned from log files
#
...
HUMAN_DATE="$(date '+%d %B %Y')"   # e.g. "20 March 2026"
